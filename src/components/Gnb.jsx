...
import './Gnb.css'      // stylesheet 불러오기
        ...
        <>
            <nav className='gnb'>
                <div className='gnb-container'>
                    ...
                    {/* 오른쪽 영역 : 로그인 상태에 따른 로그인/회원가입 또는 유저정보/로그아웃 */}
                            ...
                            isLoading ? (
                                ...
                                <>
                                    ...
                                    <Link to="/profile" className='gnb-user-info'>
                                        <img src={user.profileImage} className='gnb-user-image'/>
                                        <span className='auth-user'>{user.username}님</span>
                                    </Link>
